...
# --- Configuration ---
input_folder = "C:/Users/HP/Desktop/CODE-Green/ML taxonomy/ML-framework-s-taxonomy/padded/train/padded_output_class3"  # Make sure this folder exists and contains images
output_folder = "./gradcam_results_on_efficientnet_bo/class3"
...
target_layer_name = 'features.7'  # Last convolutional block
