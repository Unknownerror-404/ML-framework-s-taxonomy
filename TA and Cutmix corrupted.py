...
# ---------------------------
# Corruption functions (for distribution shift testing)
# ---------------------------
...
def create_corrupted_dataset(src_dir, dst_dir, overwrite: bool = False):
    # If corrupted dataset already exists and overwrite is False, skip regeneration
    ...
    for cls in os.listdir(src_dir):
        ...
        for fname in os.listdir(cls_src):
            ...
            save_jpeg_quality(noisy_img, os.path.join(cls_dst, fname), quality=40)
...
train_transform = transforms.Compose([
    ...
    transforms.TrivialAugmentWide(),  # TA applied first
    transforms.ToTensor(),
...
create_corrupted_dataset(f"{data_dir}/test", corrupt_test_dir, overwrite=True)
